"""Orbit Wars v10c — v5 + blackout fix: a tiny-need best target no longer
stalls phase 1 (send floor of 3 instead of skipping the turn), and no shots
at rotating targets on turn 0 (rotation sign unknown until the first delta).
